    ...
    return (
        <div className='about'>
            ...
            <div className='about_cont'>
                ...
                <h3>What</h3>
                <p>The Breaking Bad API is a collection of information on the Vince Gilligan series. This site is designed to make is easy on the developer to see what HTTP requests are possible, and what information is provided.</p>
                ...
                <h3>Issues</h3>
                <p>If you come across any errors, please contribute by creating an issue on <a href="https://github.com/" target='blank'>GitHub</a>! I will gladly fix correct them as soon as I can</p>
                <h3>Contact</h3>
                <p>If you would like to talk about a project you are wanting to build, or just to chat, please head over to my portfolio and send me a message. I would love to chat with you about your idea!</p>
                <h3>Copyright</h3>
